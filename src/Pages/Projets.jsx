...
projets passionnants que nous avons réalisés.Nous avons travaillé dur pour créer des solutions innovantes et répondre aux besoins de nos clients."/>
        ...
        <Bigcard bg="#BADDB7" cardtitle="Agence de voyage" cardtext="Bienvenue dans notre bibliothèque en ligne! Nous sommes ravis de vous offrir un accès facile à une vaste collection de livres numériques, d'articles de journaux, de magazines, de documents académiques et plus encore."/>
        <Pagination/>
